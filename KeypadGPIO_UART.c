...
#define KR0_Pin GPIO_PIN_0

#define KR1_GPIO_Port GPIOA
#define KR1_Pin GPIO_PIN_1

#define KR2_GPIO_Port GPIOA
#define KR2_Pin GPIO_PIN_2

#define KR3_GPIO_Port GPIOA
#define KR3_Pin GPIO_PIN_3

#define KC0_GPIO_Port GPIOA
#define KC0_Pin GPIO_PIN_4
...
#define KC3_GPIO_Port GPIOA
#define KC3_Pin GPIO_PIN_7
/* USER CODE END PD */
...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  KEY=Get_Key();
	  sprintf(hold,"%c\r\n",KEY);
	  HAL_UART_Transmit(&huart1, (uint8_t*)hold, strlen(hold), 100);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
}
